---
title: "MindCycle"
description: "Documentação do produto e do projeto MindCycle — Requisitos de Software 2026.2, Turma 02, FCTE/UnB."
---
...
{{< wordmark >}}
  ...
  <div class="home-hero-body">
    ...
    <p>
      ...
      desenvolvido para o <strong>Laboratório de Competência em Software Livre
...
como iguais e transformam oscilações fisiológicas normais em percepção de baixo desempenho.
O MindCycle propõe o contrário — planejar a partir da capacidade real da usuária, tratando o
descanso como parte legítima da rotina e mantendo os dados de ciclo e sintomas sob controle
exclusivo de quem os registra.
...
| | |
|---|---|
| **Produto** | MindCycle — organização de tarefas adaptada ao ciclo menstrual |
| **Cliente/Parceiro** | Laboratório de Competência em Software Livre (LabLivre) — FCTE/UnB |
| **Representante do cliente** | Daniela Soares |
| **Disciplina** | Requisitos de Software — 2026.2 — Turma 02 |
| **Abordagem** | Híbrida · ciclo de vida iterativo e incremental · processo OpenUP · framework Kanban |
| **Repositório** | [mdsreq-fga-unb/REQ-2026.2-T02-MindCycle](https://github.com/mdsreq-fga-unb/REQ-2026.2-T02-MindCycle) |
...
[Seção 7.1 — Composição da Equipe](visao/07-interacao-equipe-cliente/#71-composição-da-equipe).

<h2 class="home-section-title">Histórico de revisão</h2>
